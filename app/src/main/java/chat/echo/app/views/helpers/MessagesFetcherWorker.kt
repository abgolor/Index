...
import chat.echo.app.SimplexService.Companion.showPassphraseNotification
  ...
  override suspend fun doWork(): Result {
    ...
    try {
      withTimeout(durationSeconds * 1000L) {
        ...
        delay(10_000)
        while (!isStopped) {
          Log.i(TAG, "doWork: kast message received at ${chatController.lastMsgReceivedTimestamp}")
