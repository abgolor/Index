...
object CompressDecompress {
  @Throws(IOException::class) fun compress(str: String?): ByteArray? {
  ...
  @Throws(IOException::class) fun decompress(compressed: ByteArray?): String {
